...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow_practise_new")
    bq_project = Variable.get("bq_project", default_var="striking-bot-465313-t9")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"airflow-project-cicd/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/airflow-project-cicd/spark-job/spark_transformation_job.py",  # Main Python file
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "698081400429-compute@developer.gserviceaccount.com",
                "network_uri": "projects/striking-bot-465313-t9/global/networks/default",
                "subnetwork_uri": "projects/striking-bot-465313-t9/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="striking-bot-465313-t9",
        region="us-central1",
